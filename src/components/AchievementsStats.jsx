...
const CHANNEL_INSIGHTS = [
  {
    ...
    mainMetric: '2K+',
    metricLabel: 'Lượt xem bài viết & Reels • 416 Follow',
    subMetric: '416 Followers • 39 Đang theo dõi • Tương tác cao',
    tag: 'Kết nối',
    highlight: 'Các bài viết cuộc sống, cập nhật dự án công nghệ & tương tác tích cực cùng bạn bè',
  },
  {
    id: 'fb-fanpage',
    name: 'Fanpage: Uống Gì Hôm Nay',
    handle: 'Uống gì hôm nay (Trang chính thức)',
    url: 'https://www.facebook.com/share/1AfnEdbkeu/?mibextid=wwXIfr',
    icon: FacebookIcon,
    themeColor: 'blue',
    badgeColor: 'bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/25',
    glowColor: 'group-hover:border-blue-500/50 group-hover:shadow-[0_0_25px_rgba(59,130,246,0.25)]',
    mainMetric: 'Reels & Demo',
    metricLabel: 'Trang chính thức • Video Demo Test',
    subMetric: 'Fanpage chính thức dự án Hôm Nay Uống Gì Lio',
    tag: 'Official Fanpage',
    highlight: 'Kênh truyền thông chính thức cập nhật bản thử nghiệm, link test và video Reels của dự án',
  },
  {
    id: 'tiktok-personal',
    name: 'TikTok Cá Nhân',
