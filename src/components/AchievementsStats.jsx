...
const CHANNEL_INSIGHTS = [
  ...
  },
  {
    ...
    mainMetric: '131',
    metricLabel: 'Followers • 89 Following',
    subMetric: 'Nhiếp ảnh Canon • Portfolio Visual',
    tag: 'Photography & Art',
    highlight: 'Kho ảnh nghệ thuật, hành trình tập chụp ảnh máy cơ Canon và phong cách sống',
  },
  {
    id: 'tiktok-story',
